...
public class Lista2 {
    ...
    public void addBegin(Nodo2 nuevo){
        if(isEmpty()){
            inicio = nuevo;
            fin = nuevo;
        }else{
    ...
    public void insertAt(int pos, Nodo2 nuevo) throws Exception{
        if(isEmpty()){
            inicio = nuevo;
            fin = nuevo;
        }else{
    ...
    public void setAt(int pos, String val){
        //VERIFICAR si no hay nodos, si pos no es válido
        int iCont = 0;
        Nodo2 temp = inicio;
        while(iCont < pos){
